package com.michaelRunzler.ARK.android;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setDefaultUIContentActions();
    }

    /**
     * Sets the default UI actions for this UI template.
     * Use the setUIContextActions() method for your own custom UI actions.
     */
    public void setDefaultUIContentActions()
    {
    ...
    /**
     * Use this method to add your own UI actions through the shortcut methods
     * listed in the Utility/Shortcut Method section.
     */
    public void setUIContentActions()
    {
    ...
    public void showSettings(View view) {
        findViewById(R.id.main_sidebar_settings_button).animate().rotation(360.0f).setDuration(1000).setInterpolator(new AccelerateDecelerateInterpolator());
        //todo finish
    }
